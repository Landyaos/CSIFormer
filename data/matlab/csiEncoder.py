...
def load_model():
    ...
    model.load_state_dict(torch.load(os.path.join('../../checkpoints', model.__class__.__name__ + '_v3_best.pth'), map_location=device)['model_state_dict'])
    print('load model path : ',os.path.join('../../checkpoints', model.__class__.__name__ + '_v3_best.pth'))
    return model
