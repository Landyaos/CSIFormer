...
for idx = 1:length(snrValues)
    ...
    for frame = -1:numCountFrame
        ...
        hPerfect = h(dataIndices-numGuardBands(1),:,:,:);
        ...
        csi_ai = csi_ai(dataIndices-numGuardBands(1),:,:,:);
        ...
        eqAISignal = eqInfer(eqDnnModel, h, finalSignal(validSubcIndices,:,:));
        eqAISignal = eqAISignal(dataIndices-numGuardBands(1), :,:);
